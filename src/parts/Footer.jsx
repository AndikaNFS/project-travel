    ...
    <div className="container mx-auto">
      <div className="flex">
        <div className="w-96 h-58 ">
          <img src="/images/img-logo-travee.png" alt="" className="mb-3" />
          <p>
            Pandooin merupakan start-up yang bergerak dalam bidang travel.
            Dengan mengusung konsep rural tourism dan ecotourism, Pandooin
            berkomitmen untuk memulihkan industri pariwisata di Indonesia.
          </p>
        </div>
        <div className="w-64 h-58 ml-6">
