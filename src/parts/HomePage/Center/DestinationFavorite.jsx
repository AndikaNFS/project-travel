...
function DestinationFavorite() {
  return (
    <div className="flex">
      ...
      {/* <div class="w-50 m-2 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        <a href="#">
          <img
            class="rounded-t-lg z-30"
            src="/images/destination-2.jpeg"
            alt=""
          />
          <div class="p-5 z-30 ">
